 ...
 * @author Arsiela
 */
public class Gift_Check implements GTransaction{
    GRider poGRider;
    String psBranchCd;
    boolean pbWtParent;
    int pnEditMode;
    ...
    Model_Gift_Check poModel;
    ArrayList<Model_Gift_Check> paDetail;
    
    public Gift_Check(GRider foGRider, boolean fbWthParent, String fsBranchCd) {
        poGRider = foGRider;
        pbWtParent = fbWthParent;
        psBranchCd = fsBranchCd.isEmpty() ? foGRider.getBranchCode() : fsBranchCd;

        poModel = new Model_Gift_Check(foGRider);
    ...
    @Override
    public Model_Gift_Check getMasterModel() {
        return poModel;
    }
    ...
    public JSONObject newTransaction() {
        ...
        try{
            ...
            poModel = new Model_Gift_Check(poGRider);
    ...
    public JSONObject saveTransaction() {
        ...
        ValidatorInterface validator = ValidatorFactory.make( ValidatorFactory.TYPE.Gift_Check, poModel);
...
//        return poJSON;
    ...
    public JSONObject searchTransaction(String fsValue, boolean fbByCode) {
        String lsHeader = "Gift Check No";
        String lsColName = "sGCertNox";
    ...
    public void setTransactionStatus(String string) {
     ...
     public ArrayList<Model_Gift_Check> getDetailList(){
        if(paDetail == null){
    ...
    public void setDetailList(ArrayList<Model_Gift_Check> foObj){this.paDetail = foObj;}
    ...
    public Model_Gift_Check getDetailModel(int fnRow) {
...
//                while(loRS.next()){
//                        paDetail.add(new Model_Gift_Check(poGRider));
...
//    
//    ArrayList<Model_Gift_Check> paDetail;
//    ArrayList<Model_Gift_Check> paRemDetail;
//
...
//        poJSON = new JSONObject();
//        Model_Gift_Check loEntity = new Model_Gift_Check(poGRider);
...
//            paRemDetail.add(new Model_Gift_Check(poGRider));

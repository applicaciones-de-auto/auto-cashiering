...
public class SalesInvoice_Source implements GTranDet {
    ...
    @Override
    public Model_VehicleSalesInvoice getDetailModel(int fnRow) {
...
//            paDetail.get(lnCtr).setTargetBranchCd(psTargetBranchCd);
            ...
            ValidatorInterface validator = ValidatorFactory.make(ValidatorFactory.TYPE.VehicleSalesInvoice, paDetail.get(lnCtr));
...
//    }
    ...
    public void setDetailList(ArrayList<Model_VehicleSalesInvoice> foObj){this.paDetail = foObj;}

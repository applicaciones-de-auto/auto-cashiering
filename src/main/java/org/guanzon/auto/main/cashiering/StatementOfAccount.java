...
import org.guanzon.auto.controller.cashiering.StatementOfAccount_Detail;
 ...
 * @author Arsiela
 */
public class StatementOfAccount implements GTransaction{
    GRider poGRider;
    String psBranchCd;
    boolean pbWtParent;
    int pnEditMode;
    ...
    StatementOfAccount_Master poController;
    StatementOfAccount_Detail poDetail;
    
    public StatementOfAccount(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new StatementOfAccount_Master(foAppDrver,fbWtParent,fsBranchCd);
        poDetail = new StatementOfAccount_Detail(foAppDrver);
    ...
    public JSONObject openTransaction(String fsValue) {
        ...
        poJSON = checkData(poDetail.openDetail(fsValue));
...
//        poDetail.setTargetBranchCd(poController.getMasterModel().getBranchCD());
    ...
    @Override
    public StatementOfAccount_Master getMasterModel() {
        return poController;
    }
    @Override
    ...
    public StatementOfAccount_Detail getDetailModel(){return poDetail;} 
    public ArrayList getDetailList(){return poDetail.getDetailList();}
    public Object addDetail(){ return poDetail.addDetail(poController.getMasterModel().getTransNo());}
    public Object removeDetail(int fnRow){ return poDetail.removeDetail(fnRow);}
    ...
    private JSONObject validateEntry(){
        ...
        //Validate SOA Detail required
        if(poDetail.getDetailList().size() - 1 < 0 && poDetail.getDetailList().size() - 1 < 0){
            loJSON.put("result","error");
            loJSON.put("message", "SOA Detail cannot be empty.");
            return loJSON;
        }
